...
public class PlayerHealthSplit1 : MonoBehaviour
{
    public CollisionSplit2 collisionScript; // nastavy se CollisionSplit2

    public GameManager2 gameManager; // nastavy se gameManager2

    public Animator animator; // Animator komponenta hráèe

    public CollisionSplit2 aiCollision; // nastavy se CollisionSplit2
    ...
    void Start()
    {
        ...
        collisionScript = GetComponent<CollisionSplit2>();
