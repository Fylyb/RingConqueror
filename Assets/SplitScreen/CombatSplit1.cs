...
public class CombatSplit1 : MonoBehaviour
{
    ...
    public PlayerHealthSplit1 playerHealth; // bude odkazovat na playerhealthsplit1
    public PlayerHealthSplit2 aiHealth; // bude odkazovat na playerhealthsplit2

    public GameManager2 gameManager; // bude odkazovat na gamemanager2
